package com.ouer.tools.generator.code.model;
...
/**
 * Created by xuanwu on 2015/5/18.
 */
public class OuerModelGenerator extends AbstractJavaGenerator {
    public OuerModelGenerator() {
        super();
    }
